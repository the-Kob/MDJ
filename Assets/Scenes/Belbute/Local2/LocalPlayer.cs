...
public class LocalPlayer : MonoBehaviour
{
	...
	private bool climbFlag;
	public void OnClimb(InputAction.CallbackContext ctx) => climbFlag = ctx.performed;

	private bool jumpFlag;
	public void OnJump(InputAction.CallbackContext ctx) => jumpFlag = ctx.performed;
    ...
    void Update ()
	{
		...
		Moving = movementInput != Vector2.zero ? true : false; // moving check
